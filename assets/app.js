...
const ICONS={
  ...
  /* filled glyphs for contact cards (.ct-ico uses fill, not stroke) */
  ...
  mailf:'<path d="M3 5.5h18c.55 0 1 .45 1 1v.3l-10 5.9L2 6.8v-.3c0-.55.45-1 1-1z"/><path d="M2 8.6V17.5c0 .55.45 1 1 1h18c.55 0 1-.45 1-1V8.6l-9.5 5.6c-.31.18-.69.18-1 0L2 8.6z"/>',
  pinf:'<path fill-rule="evenodd" d="M12 2C8.7 2 6 4.7 6 8c0 4.5 6 12 6 12s6-7.5 6-12c0-3.3-2.7-6-6-6zm0 8.3A2.3 2.3 0 1 1 12 5.7a2.3 2.3 0 0 1 0 4.6z"/>',
  clockf:'<path fill-rule="evenodd" d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm1 4h-2v7h6v-2h-4V6z"/>',
  alertf:'<path fill-rule="evenodd" d="M12 2.5 1.5 21h21L12 2.5zm-1 6.5h2v6h-2V9zm0 8h2v2h-2v-2z"/>',
